...
public abstract class RightLowConeStack extends AutoMain {
...
//        scoreConeOne(Bot);
    ...
    public void scoreHigh(CompetionBot Bot) throws InterruptedException {
        ...
        Bot.driveForwardGyro(0.3, 0.75);
        sleep(1000);  // robot sways so holding a second
    ...
    public void parkZone (CompetionBot Bot, AutoTargetZone target) throws InterruptedException {
        switch (target) {
            case A:
                ...
                Bot.driveForwardGyro(0.7, 2.3);
                sleep(sleepTime);

                Bot.rotateLeft(0.4, 1.9);
                sleep(sleepTime);
//             DO NOT GYRO CORRECT TO -180 -- WEIRD THINGS HAPPEN!!!
            ...
            case B:
                ...
                Bot.driveBackwardGyro(0.7, 0.75);
                sleep(sleepTime);
            ...
            case C:
                ...
                Bot.driveBackwardGyro(.7, 1.4);
                sleep(sleepTime);

                Bot.rotateRight(0.4, 1.8);
                sleep(sleepTime);

                Bot.strafeRight(0.3, 0.4);
                sleep(sleepTime);
