...
import org.firstinspires.ftc.teamcode.Compitition.ZPowerPlay.controls.Autonomus.Test.GyroDriveTest.CompetitionGyroTest.AutoMain;
import org.firstinspires.ftc.teamcode.Compitition.ZPowerPlay.controls.Autonomus.Test.GyroDriveTest.CompetitionGyroTest.AutoTargetZone;
    ...
    public void parkplace (CompetionBot Bot, AutoTargetZone target) throws InterruptedException{
        switch (target) {
            case A:
                ...
                blueLeftStack_GyroTest(Bot);
                sleep(sleepTime);

                Bot.driveGyroStrafe(0.4, 2.5, "left");
                sleep(sleepTime);

//                Bot.strafeLeft_PID(0.4, 2.5);
//                sleep(sleepTime);

                Bot.driveBackwardGyro(0.4, 0.3);
                sleep(sleepTime);
            ...
            case C:
                ...
                Bot.driveGyroStrafe(0.4, 2.75, "right");
                sleep(sleepTime);
    ...
    //strafer kit dont mess with dont need it
    ...
    public void blueLeftStack_GyroTest(CompetionBot Bot) throws InterruptedException {
