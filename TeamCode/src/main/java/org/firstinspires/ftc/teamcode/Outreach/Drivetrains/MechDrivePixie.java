...
//VEERING TO LEFT!
    ...
    public void speedAcceleration(double rotations, double maxPower, MecanumDrive.driveDirections driveDirection) {
        ...
        if (driveDirection == MecanumDrive.driveDirections.DRIVE_FORWARD || driveDirection == MecanumDrive.driveDirections.DRIVE_BACK) {
            minPowerStart = 0.2;
            minPowerStop = 0.2;
        }
        else {
...
//            currentDistance = frontLeftMotor.getCurrentPosition();
    ...
    public void speedAccelerationStrafe (double rotations, double maxPower, MecanumDrive.driveDirections driveDirection) {
        double targetDistance = rotations * TICKS_PER_ROTATION;
